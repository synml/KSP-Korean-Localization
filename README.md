...
**Kerbal Space Program 1.12.x** 본편과 **Making History·Breaking Ground DLC**의 한국어 번역 패치입니다.
...
- 본편(Making History 포함) **12,030개** + Breaking Ground **724개** 모든 문자열 번역 수록.
...
> KSP가 `Program Files` 안에 있으면 관리자 권한이 필요합니다. 배치파일이 자동으로 확인 후 권한을 요청합니다.
